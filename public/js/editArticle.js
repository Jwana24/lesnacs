if(document.querySelector('.btn-edit-article'))
{
    ...
    editButton.addEventListener('click', (e) =>
    {
        ...
        else if(e.target.dataset['toggle'] == 'true')
        {
            ...
            fetch('http://lesnacs.fr/article/edition/'+e.target.dataset['id']+'/', {method: 'POST', body: data}).then(promise => promise.text()).then(promise =>
            {
                ...
                if(statut == 'success')
                {
                    ...
                    image.src = 'http://lesnacs.fr/' + article['image'];
